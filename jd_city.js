...
let inviteCodes =  ["_rG-A_VZYGNLL17EBpfUh6I","57y8JNZfExMjGEW5FpqJu7Bw0sKmLQ","57ykH9ZKAQQ_O3ehC6iJu_Rc_vSZag"]
!(async () => {
  if (!cookiesArr[0]) {
    $.msg($.name, '【提示】请先获取京东账号一cookie\n直接使用NobyDa的京东签到获取', 'https://bean.m.jd.com/bean/signIndex.action', {"open-url": "https://bean.m.jd.com/bean/signIndex.action"});
    return;
  }
  readShareCodeRes = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/city.json')
  await requireConfig();
  if (exchangeFlag) {
    console.log(`脚本自动抽奖`)
  } else {
