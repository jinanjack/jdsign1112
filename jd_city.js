...
let author_codes = ["_rG-A_VZYGNLL17EBpfUh6I","57y8JNZfExMjGEW5FpqJu7Bw0sKmLQ","57ykH9ZKAQQ_O3ehC6iJu_Rc_vSZag","-ryUXKQKMGZHNxCQG9_No9_OorAEph4X","-ryUXK1YbzEWYhvGTtqQ9WUQjdF1SwUX"].sort(() => 0.5 - Math.random())
const self_code = []
let pool = []
!(async () => {
    await $.wait(15000)
